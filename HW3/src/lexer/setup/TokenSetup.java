...
public class TokenSetup {
    ...
    TokenSetup() {
        try {
            ...
            in = new BufferedReader( new FileReader("src" + sep + "lexer" + sep + "setup" + sep + "tokens"));
            table = new PrintWriter(new FileOutputStream("src" + sep + "lexer" + sep + "TokenType.java"));
            symbols = new PrintWriter(new FileOutputStream("src" + sep + "lexer" + sep + "Tokens.java"));
        } catch (Exception e) {
