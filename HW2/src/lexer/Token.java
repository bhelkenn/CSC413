...
*/
public class Token {
  private int lineNumber, leftPosition,rightPosition;
  private Symbol symbol;

/**
 *  Create a new Token based on the given Symbol
 *  @param lineNumber is the source file row of the Token
...
*/
  ...
  public void print() {
    System.out.println(lineNumber + ".       " + symbol.toString() + 
                       "             left: " + leftPosition +
                       " right: " + rightPosition);
  }
