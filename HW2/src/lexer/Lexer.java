 ...
 *  @param lineNumber is the row in the source file
...
*/
    public Token newIdToken(String id, int lineNumber, int startPosition,int endPosition) {
        return new Token(lineNumber,startPosition,endPosition,Symbol.symbol(id,Tokens.Identifier));
    }
...
*/
    public Token newNumberToken(String number,int lineNumber,int startPosition,int endPosition) {
        return new Token(lineNumber,startPosition,endPosition,
...
*/
    public Token nextToken() { // ch is always the next char to process
        ...
        if (Character.isJavaIdentifierStart(ch)) {
            ...
            return newIdToken(id,source.getLineno(),startPosition,endPosition);
        }
        if (Character.isDigit(ch)) {
            ...
            return newNumberToken(number,source.getLineno(),startPosition,endPosition);
        }
        ...
        try {
            ...
            if (sym == null) {  // it must be a one char token
                return makeToken(charOld,source.getLineno(),startPosition,endPosition);
            }
            endPosition++;
            ch = source.read();
            return makeToken(op,source.getLineno(),startPosition,endPosition);
        } catch (Exception e) {}
        atEOF = true;
